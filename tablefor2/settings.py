"""
Django settings for tablefor2 project.
...
# SECRET_KEY = 'django-insecure-jwrw6reapfi-)4inftkp%jyr=x1-#ue%)!&u#$jnxk&n3udxg5'
SECRET_KEY = os.environ.get('SECRET_KEY')  # added

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['test-resturantbooking.herokuapp.com', 'localhost']
